            ...
            return settings.today = clearTime(new Date).getTime(),
                ...
                settings.increaseHours = function () {
                    if (settings.mainObj.constraint) {
                        ...
                        var whatToCompare = ((24 == settings.mainObj.format) ? settings.time.hours : (settings.time.meridian === 'AM' ? (settings.time.hours % 12): (settings.time.hours % 12)+ 12));
                ...
                settings.changeMeridian = function () {
                    /** @type {string} */
                    if (settings.mainObj.constraint) {
                        var whatToCompare = (settings.time.meridian === 'AM' ? (settings.time.hours % 12): (settings.time.hours % 12)+ 12);
