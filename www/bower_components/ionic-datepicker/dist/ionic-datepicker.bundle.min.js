    ...
    this.configDatePicker = function (t) {
        angular.extend(e, t)
            ...
            function d(e) {
                ...
                u.monthsList = [], u.monthsList = u.mainObj.monthsList && 12 === u.mainObj.monthsList.length ? u.mainObj.monthsList : a.monthsList;
                u.yearsList = a.getYearsList(u.mainObj.from, u.mainObj.to), u.dayList = [];
                var o, c;
                ...
                for (var d = t; n >= d; d++)
                    o = new Date(e.getFullYear(), e.getMonth(), d), c = o.getTime() < u.fromDate || o.getTime() > u.toDate || u.mainObj.disableWeekdays.indexOf(o.getDay()) >= 0, u.dayList.push({
                        date: o.getDate(),
                        month: o.getMonth(),
                        year: o.getFullYear(),
                        day: o.getDay(),
                ...
                for (var p = 0; r > p; p++)
                    u.dayList.unshift({});
                u.rows = [0, 7, 14, 21, 28, 35], u.cols = [0, 1, 2, 3, 4, 5, 6], u.currentMonth = u.mainObj.monthsList[e.getMonth()];
                u.currentYear = u.yearsList.find(function (el) {
                    return el === e.getFullYear();
                }).toString();
            ...
            function r(e) {
                u.mainObj = angular.copy(e), u.selectedDateEpoch = i(u.mainObj.inputDate).getTime(), u.weeksList = u.mainObj.weeksList && 7 === u.mainObj.weeksList.length ? u.mainObj.weeksList : ["S", "M", "T", "W", "T", "F", "S"], u.mainObj.mondayFirst && u.weeksList.push(u.mainObj.weeksList.shift()), u.disableWeekdays = u.mainObj.disableWeekdays, d(u.mainObj.inputDate), c(u.mainObj)
            }
            ...
            return u.today = i(new Date).getTime(), u.disabledDates = [], u.prevMonth = function () {
                ...
                e && 0 !== Object.keys(e).length && (u.selectedDateEpoch = e.epoch, u.mainObj.closeOnSelect && (u.mainObj.callback(u.selectedDateEpoch), "popup" == u.mainObj.templateType.toLowerCase() ? u.popup.close() : l()))
            }, u.setIonicDatePickerTodayDate = function () {
                var e = new Date;
                d(new Date), u.selectedDateEpoch = i(e).getTime(), u.mainObj.closeOnSelect && (u.mainObj.callback(u.selectedDateEpoch), l())
            }, u.setIonicDatePickerDate = function () {
                u.mainObj.callback(u.selectedDateEpoch), l()
                ...
                u.mainObj = angular.extend({}, e, t), u.mainObj.from && (u.fromDate = i(new Date(u.mainObj.from)).getTime()), u.mainObj.to && (u.toDate = i(new Date(u.mainObj.to)).getTime()), t.disableWeekdays && e.disableWeekdays && (u.mainObj.disableWeekdays = t.disableWeekdays.concat(e.disableWeekdays)), r(u.mainObj), u.mainObj.closeOnSelect || (o = [{
                        ...
                        type: "button_set",
                        onTap: function (e) {
                            u.mainObj.callback(u.selectedDateEpoch)
                        }
                    ...
                    onTap: function (e) {
                        var t = new Date;
                        d(new Date), u.selectedDateEpoch = i(t).getTime(), u.mainObj.closeOnSelect || e.preventDefault()
                    }
                }), o.push({
                    text: u.mainObj.closeLabel,
                    type: "button_close",
                    onTap: function (e) {
                        u.mainObj.closeCallback();
                    }
