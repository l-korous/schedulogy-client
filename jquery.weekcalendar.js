...
/*
      ...
      */
      ...
      _setupEventCreationForWeekDay : function($weekDay) {
         ...
         $weekDay.mousedown(function(event) {
            ...
            if ($target.hasClass("wc-day-column-inner")) {
               ...
               $newEvent.css({lineHeight: (options.timeslotLineHeight - 2) + "px", fontSize: (options.timeslotLineHeight / 2) + "px"});
      ...
      _renderEvent: function (calEvent, $weekDay) {
         ...
         $calEvent.css({lineHeight: (options.timeslotLineHeight - 2) + "px", fontSize: (options.timeslotLineHeight / 2) + "px"});
